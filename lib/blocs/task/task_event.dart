...
class TaskEvent with _$TaskEvent {
  ...
  const factory TaskEvent.updateTaskById({required String id, required Task task}) =
      UpdateTaskByIdTaskEvent;

  const factory TaskEvent.deleteTaskById({required String id}) = DeleteTaskByIdTaskEvent;

  const factory TaskEvent.getTasksByProject({required String projectId}) =
      GetTasksByProjectTaskEvent;

  const factory TaskEvent.fetchTasks({required DateTime date, required CalendarFormat format}) =
      FetchTasksEvent;
