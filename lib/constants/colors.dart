...
// ----------- C O L O R S -----------
  ...
  Color kPastelBlue = const Color(0xff346cf6).withOpacity(0.57);
  const Color kPastelYellow = Color(0xfffef2c4);
  Color kPastelPurple = const Color(0xff346cf6).withOpacity(0.15);
  ...
  Color kSkeleton = const Color(0xff000000).withOpacity(0.2);
