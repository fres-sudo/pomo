...
abstract class TaskRepository {
  ...
  Future<List<Task>> fetchTasks({required DateTime date, required CalendarFormat format});
}
...
class TaskRepositoryImpl implements TaskRepository {
  ...
  @override
  Future<List<Task>> fetchTasks({required DateTime date, required CalendarFormat format}) async {
    final dateString = DateFormat("yyyy-MM-dd").format(date);
    final tasks = await taskService.getScheduledTask(dateString, format);
