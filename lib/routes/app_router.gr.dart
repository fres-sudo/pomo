  ...
  final Map<String, _i16.PageFactory> pagesMap = {
    CreateProjectRoute.name: (routeData) {
      ...
      return _i16.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i1.CreateProjectPage(key: args.key),
      );
    },
...
class CreateProjectRoute extends _i16.PageRouteInfo<CreateProjectRouteArgs> {
  CreateProjectRoute({
    _i17.Key? key,
    List<_i16.PageRouteInfo>? children,
  }) : super(
          CreateProjectRoute.name,
          args: CreateProjectRouteArgs(key: key),
          initialChildren: children,
        );

  static const String name = 'CreateProjectRoute';

  static const _i16.PageInfo<CreateProjectRouteArgs> page =
      _i16.PageInfo<CreateProjectRouteArgs>(name);
}

class CreateProjectRouteArgs {
  const CreateProjectRouteArgs({this.key});

  final _i17.Key? key;

  @override
  String toString() {
    return 'CreateProjectRouteArgs{key: $key}';
  }
}
...
class ForgotPasswordOTPRoute
    extends _i16.PageRouteInfo<ForgotPasswordOTPRouteArgs> {
  ...
  static const _i16.PageInfo<ForgotPasswordOTPRouteArgs> page =
      _i16.PageInfo<ForgotPasswordOTPRouteArgs>(name);
}
...
class ForgotPasswordRecoverRoute extends _i16.PageRouteInfo<void> {
  const ForgotPasswordRecoverRoute({List<_i16.PageRouteInfo>? children})
      : super(
...
class ProjectDetailsRoute extends _i16.PageRouteInfo<ProjectDetailsRouteArgs> {
  ProjectDetailsRoute({
    _i18.Key? key,
  ...
  static const _i16.PageInfo<ProjectDetailsRouteArgs> page =
      _i16.PageInfo<ProjectDetailsRouteArgs>(name);
}
...
class ProjectNavigation extends _i16.PageRouteInfo<void> {
  const ProjectNavigation({List<_i16.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i11.ProjectPage]
class ProjectRoute extends _i16.PageRouteInfo<void> {
  const ProjectRoute({List<_i16.PageRouteInfo>? children})
      : super(
          ProjectRoute.name,
          initialChildren: children,
        );
...
class QuickSessionRoute extends _i16.PageRouteInfo<void> {
  const QuickSessionRoute({List<_i16.PageRouteInfo>? children})
      : super(
