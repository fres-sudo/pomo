                ...
                child: InkWell(
                  ...
                  onLongPress: () => showModalBottomSheet(
                      ...
                      builder: (BuildContext context) => DestructionBottomSheet(
                          ...
                          function: () {
                            widget.breakController.restart(duration: state.breakTime * 60);
                            context.router.maybePop();
                          })),
                  child: widget.breakController.isStarted && !widget.breakController.isPaused
                      ? Icon(Icons.pause_circle_filled_rounded, color: Theme.of(context).iconTheme.color, size: 70)
                      : Icon(Icons.play_circle_fill_rounded, color: Theme.of(context).iconTheme.color, size: 70),
                ),
              ),
            ],
          ),
