  ...
  Widget build(BuildContext context) {
    return BlocListener<ProjectBloc, ProjectState>(
      listener: (context, state) {
        state.operation == ProjectOperation.update || state.operation == ProjectOperation.delete ? context.router.maybePop() : null;
      },
      child: Container(
        height: 260,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    InkWell(
                      onTap: () =>
                          showModalBottomSheet(isScrollControlled: true, context: context, builder: (context) => EditProjectView(project: project)),
                      child: Container(
                          decoration: BoxDecoration(
