...
abstract class $SignInResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, String status, UserJTO user});
...
class _$SignInResponseImpl implements _SignInResponse {
  const _$SignInResponseImpl(
      {required this.token, required this.status, required this.user});
  ...
  @override
  String toString() {
    return 'SignInResponse(token: $token, status: $status, user: $user)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, token, status, user);
...
abstract class _SignInResponse implements SignInResponse {
  const factory _SignInResponse(
      ...
      required final UserJTO user}) = _$SignInResponseImpl;
