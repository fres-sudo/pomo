...
abstract class ProjectService {
  ...
  @GET('/projects')
  Future<List<ProjectJTO>> getProjectsByUser();
  ...
  @MultiPart()
  Future<ProjectJTO> uploadProjectImageCover(
    @Path('projectId') String id,
    @Part() File image,
  );
  @DELETE('/projects/image/{projectId}')
  Future<ProjectJTO> deleteProjectImageCover(
    @Path('projectId') String id,
  );
  ...
  Future<ProjectJTO> updateTaskInProject(
      @Path('projectId') String projectId, @Path('taskId') String taskId, @Body() TaskJTO body);
  @DELETE('/projects/{id}')
  Future<void> deleteTaskFromProject(
      @Path('projectId') String projectId, @Path('taskId') String taskId);
} //
